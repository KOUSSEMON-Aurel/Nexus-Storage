...
*   **Nexus Daemon (Go)**: The orchestration layer. It manages the OAuth2 authentication lifecycle, maintains the local SQLite/FTS5 metadata index, and provides a WebDAV server for native file manager integration.
