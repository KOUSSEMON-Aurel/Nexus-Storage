...
class _TasksPageState extends State<TasksPage> {
                      ...
                      actions: [
                        if (_tasks.isNotEmpty)
                          IconButton(
                            ...
                            onPressed: () =>
                                _showClearConfirmation(context, lang),
                          ),
                      ],
                    ),
                        ...
                        sliver: SliverList(
                          delegate: SliverChildBuilderDelegate(
                            (context, index) {
                              ...
                              final int taskIndex = index - adCount;

                              if (taskIndex >= _tasks.length) return null;
                              ...
                              final path =
                                  t['file_path'] as String? ?? 'Unknown File';
                            ...
                            childCount:
                                _tasks.length + (_tasks.length ~/ 3) + 1,
                          ),
                        ),
                      ),
                  ],
  ...
  void _showClearConfirmation(BuildContext context, String lang) {
    showDialog(
      ...
      builder: (c) => AlertDialog(
        ...
        content: const Text(
          'This will remove all completed and failed tasks from your activity history.',
        ),
        actions: [
          TextButton(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            L10n.get('no_active_tasks', lang),
            style: Theme.of(context).textTheme.titleLarge,
          ),
          const SizedBox(height: AppSpacing.sm),
          const Text(
            'All your transfers will appear here',
  ...
  Widget _buildTaskItem(
    ...
    final iconData = isCompleted
        ...
        : (isFailed ? Icons.error_rounded : Icons.sync_rounded);
